...
@Component({
  selector: 'app-new-item-menu',
  templateUrl: './new-item-menu.component.html',
  standalone: true,
  imports: [CommonModule, FormsModule, TranslateModule, MatTooltipModule],
  styleUrls: ['./new-item-menu.component.scss'],
})
export class NewItemMenuComponent implements OnInit {
  @Input() items: any[] = [];
